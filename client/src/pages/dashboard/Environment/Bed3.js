...
const Bed3 = () => {
    ...
    useEffect(() => {
        ...
        socket.on('connect', () => {
            console.log('Bed3 connected to MQTT server');
        });
            ...
            <div className="bed-content-wrapper">
                ...
                <div className={`camera-section ${isFullscreen ? 'fullscreen' : ''}`}>
                    ...
                    <div className="camera-container">
                        <img 
                            src="http://192.168.0.3:81/stream"
                            alt="Bed 3 Camera Stream"
